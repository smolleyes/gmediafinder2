...
data_files = [
	...
	('share/gmediafinder/img',['data/img/sound.png','data/img/video.png','data/img/gmediafinder.png','data/img/sound.png','data/img/throbber.png','data/img/throbber.gif','data/img/yt_icone.jpg','data/img/donate.gif','data/img/paypal.gif']),
